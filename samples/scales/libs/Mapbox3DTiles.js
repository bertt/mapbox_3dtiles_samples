    ...
    */
    ...
    class Layer {
        ...
        LightsArray() {
            ...
            let hemisphereLight1 = new THREE.HemisphereLight(0xF0F0F0, 0x888888, 1);

            if (this.lighting == 'ambient') {
                arr.push(ambientLight1);
            } else if (this.lighting == 'directional') {
                arr.push(directionalLight1, directionalLight2);
            } else if (this.lighting == 'hemisphere') {
                arr.push(hemisphereLight1);
